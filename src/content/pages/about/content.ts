...
export interface AboutContent
{
  ...
  readonly agents: {
    ...
    readonly body: string;
    readonly continuation: string;
    readonly cards: readonly { readonly name: string; readonly body: string; readonly href: string }[];
  };
  readonly human: {
    readonly eyebrow: string;
    readonly title: string;
...
export const aboutContent: Readonly<Record<Locale, AboutContent>> = {
  "pt-BR": {
    ...
    agents: {
      ...
      cards: [
        { name: "Kavor", body: "Orquestração de coding agents apoiada por práticas de engenharia.", href: "https://agentkavor.com/" },
  ...
  en: {
    ...
    agents: {
      ...
      cards: [
        { name: "Kavor", body: "Coding-agent orchestration supported by engineering practices.", href: "https://agentkavor.com/" },
  ...
  es: {
    ...
    agents: {
      ...
      cards: [{ name: "Kavor", body: "Orquestación de coding agents apoyada por prácticas de ingeniería.", href: "https://agentkavor.com/" }, { name: "Kortex", body: "Agente conversacional sobre datos clínicos y operación hospitalaria.", href: "https://agentkortex.com/" }, { name: "Agent Asaph", body: "Agente en WhatsApp para equipos de música.", href: "https://agentasaph.com/" }, { name: "ViaFronteira", body: "Concierge de compras transfronterizas por WhatsApp.", href: "https://www.instagram.com/viafronteira/" }],
    },
