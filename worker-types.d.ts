/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example worker-types.d.ts` (hash: 75ade476b2ff9ae3527f49ddae2ce599)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	SITE_DATABASE: D1Database;
	NOTIFICATION_EMAIL: SendEmail;
	ASSETS: Fetcher;
	NOTIFICATION_EMAIL_FROM: "contact@digows.com";
	TURNSTILE_SECRET_KEY: string;
	COMMENT_FINGERPRINT_SECRET: string;
	COMMENT_MODERATION_SECRET: string;
	NOTIFICATION_EMAIL_DESTINATION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTIFICATION_EMAIL_FROM" | "TURNSTILE_SECRET_KEY" | "COMMENT_FINGERPRINT_SECRET" | "COMMENT_MODERATION_SECRET" | "NOTIFICATION_EMAIL_DESTINATION" | "RESEND_API_KEY" | "RESEND_MANAGEMENT_API_KEY" | "RESEND_WEBHOOK_SECRET" | "ENVIRONMENT" | "SITE_ORIGIN" | "TURNSTILE_HOSTNAMES" | "NEWSLETTER_EMAIL_FROM" | "NEWSLETTER_REPLY_TO">> {}
}
