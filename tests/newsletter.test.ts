...
import { createWelcomeEmail } from "../src/worker/newsletter/copy";
import {
...
test("welcome email copy exists for every supported locale and escapes URLs", () =>
{
  for (const locale of supportedLocales)
  {
    const email = createWelcomeEmail(locale, "https://digows.com/newsletter?source=welcome&next=\"bad\"");
